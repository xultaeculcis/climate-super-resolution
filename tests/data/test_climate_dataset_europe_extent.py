...
expected_shape_hr_3d = (3, 452, 452)
expected_shape_hr_2d = (2, 452, 452)
expected_shape_hr_1d = (1, 452, 452)
expected_shape_lr_3d = (3, 113, 113)
expected_shape_lr_2d = (2, 113, 113)
expected_shape_lr_1d = (1, 113, 113)
...
def test_should_return_proper_data(
    ...
    # arrange
    tile_df = pd.read_feather(os.path.join(data_dir, "tmax/train_europe_extent.feather"))
    stats_df = pd.read_feather(os.path.join(data_dir, "statistics_min_max.feather")).drop(columns=["file_path"])
    ...
    sut = ClimateDataset(
        df=df,
        elevation_df=pd.read_feather(os.path.join(data_dir, "elev/elev_europe_extent.feather")),
